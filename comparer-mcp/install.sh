#!/usr/bin/env bash
# comparer-mcp/install.sh — set up comparer-mcp on Ubuntu / Debian / Linux Mint
...
info()    { echo -e "${GREEN}[comparer-mcp]${RESET} $*"; }
warn()    { echo -e "${YELLOW}[comparer-mcp]${RESET} $*"; }
error()   { echo -e "${RED}[comparer-mcp] ERROR:${RESET} $*" >&2; }
...
# comparer-mcp has no required apt packages.
# It is pure Python (music21) — no system libraries needed.
info "No apt packages required for comparer-mcp."
...
echo
echo -e "${BOLD}╔══════════════════════════════════════════════════════════════╗${RESET}"
echo -e "${BOLD}║          comparer-mcp is ready to use                        ║${RESET}"
echo -e "${BOLD}╚══════════════════════════════════════════════════════════════╝${RESET}"
echo
